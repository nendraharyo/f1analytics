...
Welcome to `f1analytics` contributor's guide.
...
If you experience bugs or general issues with `f1analytics`, please have a look
...
You can help improve `f1analytics` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`f1analytics` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `f1analytics`'s files. While this mechanism can
...
```
conda create -n f1analytics python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/f1analytics.git
   cd f1analytics
   ```
...
5. Install [pre-commit]:
   ...
   `f1analytics` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/f1analytics
[issue tracker]: https://github.com/<USERNAME>/f1analytics/issues
