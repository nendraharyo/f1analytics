...
for message in consumer:
    ...
    # print(message.value)
    tlmy_df, weather_df, race_df = converter.convert_ntt(message.value)
    ...
    tlmy_df.to_sql("telemetry_imola_2024", conn, if_exists="append")
    weather_df.to_sql("weather_imola_2024", conn, if_exists="append")
    race_df.to_sql("racestats_imola_2024", conn, if_exists="append")
